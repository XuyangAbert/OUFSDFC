...
#                current_summary = np.reshape(current_summary, (len(SF),2))
            ...
            print('The '+str(fold_id)+"th Finish!")
            fold_id += 1
    ...
    print('10 runs average number of selected features using 10-fold cross validation: ', np.mean(sfk_hist))
    ...
    print('10 runs average number of selected features using 10-fold cross validation: ', np.mean(sfd_hist))
